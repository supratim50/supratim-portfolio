  ...
  return (
    <div className='mb-[4rem] md:mb-[8rem]'>
        ...
        <p className="text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sequi accusantium, eaque dolor dolores natus harum? Tempora veritatis officiis unde corrupti quia in, ipsam reiciendis, accusamus, aliquam et odio magnam quam.
        </p>
    </div>
  )
}
