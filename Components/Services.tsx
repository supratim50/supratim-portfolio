            ...
            <div>
                <div className="bg-red-700 hover:scale-110 transform transition-all duration-300 hover:-rotate-6 uppercase font-semibold text-center p-[2rem]">
                    ...
                    <p className='text-[15px] text-[#d3d2d2]'>
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aperiam, recusandae. Labore hic praesentium, nam quis corporis reiciendis ipsum delectus. Sapiente quaerat dolorum at delectus sunt nostrum nulla totam et quasi.
                    </p>
                </div>
            </div>
            {/* 2ND */}
